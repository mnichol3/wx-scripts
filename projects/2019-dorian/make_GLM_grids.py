...
def grid_setup(args):
    ...
    date = datetime(start_time.year, start_time.month, start_time.day, start_time.hour)
    # grid_dir = os.path.join('/data/LCFA-production/', 'grid_test')
    # outpath = grid_dir+'/20%s' %(date.strftime('%y/%b/%d'))
    outpath = os.path.join(args.outdir, date.strftime('%j/%H'))
...
if __name__ == '__main__':
    ...
    arg_list1 = ['python', '/home/mnichol3/Coding/glmtools/glmtools/examples/grid/make_GLM_grids.py',
                 '-o', '/media/mnichol3/pmeyers1/MattNicholson/storms/dorian/glm/gridded',
                 '--fixed_grid', '--split_events', '--goes_position=east', '--goes_sector=conus',
                 '--dx=2.0', '--dy=2.0', '--start=2019-09-01T16:40:00', '--end=2019-09-01T16:45:00',
                 '/media/mnichol3/pmeyers1/MattNicholson/storms/dorian/glm/aws/244/16/OR_GLM-L2-LCFA_G16_s20192441640000_e20192441640200_c20192441640217.nc',
                 '/media/mnichol3/pmeyers1/MattNicholson/storms/dorian/glm/aws/244/16/OR_GLM-L2-LCFA_G16_s20192441640200_e20192441640400_c20192441640427.nc',
                 '/media/mnichol3/pmeyers1/MattNicholson/storms/dorian/glm/aws/244/16/OR_GLM-L2-LCFA_G16_s20192441640400_e20192441641000_c20192441641029.nc'
                 ]


    arg_list2 = ['-o', '/media/mnichol3/pmeyers1/MattNicholson/storms/dorian/glm/gridded',
                 '--fixed_grid', '--split_events', '--goes_position=east', '--goes_sector=conus',
                 '--dx=2.0', '--dy=2.0', '--start=2019-09-01T16:40:00', '--end=2019-09-01T16:45:00',
                 '/media/mnichol3/pmeyers1/MattNicholson/storms/dorian/glm/aws/244/16/OR_GLM-L2-LCFA_G16_s20192441640000_e20192441640200_c20192441640217.nc',
                 '/media/mnichol3/pmeyers1/MattNicholson/storms/dorian/glm/aws/244/16/OR_GLM-L2-LCFA_G16_s20192441640200_e20192441640400_c20192441640427.nc',
    ...
    args = parser.parse_args(arg_list2)
    ...
    # tracer.runfunc(gridder, glm_filenames, start_time, end_time, **grid_kwargs)
